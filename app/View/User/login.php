  ...
  <body>
    <div class="flex justify-center items-center h-screen bg-[#DDEEE0]">
      ...
      <div class="absolute flex  opacity-0 top-8 bg-white border w-60 h-24 rounded-xl items-center shadow ">
        <img src="../../../../asset/assets/icon/check.png" alt="login berhasil" class="w-10 h-10 m-2">
        ...
        <img src="../../../../asset/assets/icon/peringatan.png" alt="nip atau password salah" class="w-10 h-10 m-2">
