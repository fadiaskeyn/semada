...
{
    try {
        $query = "SELECT noinduk, nama, jabatan, alamat, gender FROM staff WHERE noinduk = :noinduk";
        $stmt = $this->conn->prepare($query);
    ...
    {
        try {
            $query = "UPDATE staff SET noinduk = :noinduk, nama = :nama, jabatan = :jabatan, alamat = :alamat, gender = :gender WHERE noinduk = :noinduk";
            $stmt = $this->conn->prepare($query);
...
{
    try {
        $query = "DELETE FROM staff WHERE noinduk = :noinduk";
        $stmt = $this->conn->prepare($query);
        $stmt->bindParam(':noinduk', $noinduk);
        $stmt->execute();
